...
?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
            ...
            <section class="tw-flex tw-flex-col tw-border-gray-200 tw-border-t tw-px-4 md:tw-px-0 xl:tw-px-0">
                <div>
                ...
                <div class="tw-flex tw-col-span-full tw-flex-wrap tw-w-full tw-mt-8">
                    <?php includeWithVariables((get_template_directory() . '/components/subscribe-cta.php'),
                        array(
                            'title' => 'Need more information? Maybe we can help with that.',
